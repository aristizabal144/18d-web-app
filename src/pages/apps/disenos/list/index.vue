  ...
  <section>
    <VCard>
      ...
      >
        ...
        <template #item.referencia="{ item }">
          <div class="d-flex align-center gap-3">
            ...
            <VAvatar
              ...
              variant="tonal"
            >
              <VIcon icon="tabler-cube-3d-sphere" size="22" />
            </VAvatar>
            <span class="font-weight-bold" style="font-family: monospace; letter-spacing: 0.5px;">
              {{ item.referencia }}
            </span>
          </div>
        </template>
        ...
        <template #item.cliente_id="{ item }">
          <div class="d-flex align-center gap-2">
            <VAvatar size="28" color="info" variant="tonal" class="font-weight-medium">
        ...
        <template #item.responsable_id="{ item }">
          <div class="d-flex align-center gap-2">
            <VAvatar size="28" color="warning" variant="tonal" class="font-weight-medium">
        ...
        <template #item.fecha_inicio="{ item }">
          <div class="d-flex flex-column">
            <span class="text-sm">
              <VIcon icon="tabler-calendar-event" size="14" class="me-1" />
              {{ formatDate(item.fecha_inicio) }}
            </span>
            <span class="text-sm text-disabled">
              <VIcon icon="tabler-calendar-check" size="14" class="me-1" />
      ...
      <div v-else>
            ...
            >
              ...
              >
                ...
                <div class="diseno-card__image-wrapper">
                  ...
                  >
                    <VIcon icon="tabler-cube-3d-sphere" size="48" color="primary" style="opacity: 0.4;" />
                  </div>
                ...
                <VCardText class="pb-2">
                  ...
                  <h6 class="text-base font-weight-semibold mb-1">{{ diseno.titulo }}</h6>
                  <p
                  ...
                  <div class="d-flex flex-column gap-2 mb-3">
                    ...
                    <!-- Responsable -->
                    <div class="d-flex align-center gap-2">
                      <VAvatar size="24" color="warning" variant="tonal">
        ...
        >
          <VIcon icon="tabler-cube-3d-sphere" size="64" color="secondary" class="mb-4" style="opacity: 0.3;" />
          <h6 class="text-h6 text-disabled mb-1">Sin diseños</h6>
          <p class="text-sm text-disabled mb-4">No se encontraron diseños con los filtros actuales.</p>
          <VBtn
            prepend-icon="tabler-plus"
            :to="{ name: 'apps-disenos-create' }"
          >
